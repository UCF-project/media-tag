...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '/ext-lib/pdf.worker.js';
...
function webViewerLoad(event) {
  var config = getViewerConfiguration();
  window.PDFViewerApplication = pdfjsWebApp.PDFViewerApplication;
  // if (event) {
  //   config.defaultUrl = event.url;
  // }
...
// document.addEventListener('ReadyToRender', webViewerLoad, true);
// window.PDFViewerApplication = pdfjsWebApp.PDFViewerApplication;
