...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(87), __webpack_require__(309)(module), __webpack_require__(116)))
...
var debug = (0, _debug2.default)('MT:Crypto'); /* global document, mediaTag, URL, fetch, Blob */
  ...
  */
	...
	startup: function startup(mediaObj) {
		...
		getBlobFromUrl(elementSource).then(function (fileEncryptedBlob) {
			...
			var fileDecryptedBlob = new Blob([fileArrayBuffer], { type: type2Mime(elementType) });
...
var flag = __webpack_require__(119),
    getActual = __webpack_require__(323),
    inspect = __webpack_require__(316),
    objDisplay = __webpack_require__(327);
