define(function (require, exports, module) {/* global document, MutationObserver */
const mediaTagAPI = require('../presets/static/media-tag'); // require('../core/media-tag-api.js');
