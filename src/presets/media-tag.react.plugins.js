 ...
 * React renderers
 */
const ImagePlugin		= require('../react/plugins/image/renderer');
const AudioPlugin		= require('../react/plugins/audio/renderer');
const VideoPlugin		= require('../react/plugins/video/renderer');
const PdfPlugin			= require('../react/plugins/pdf/renderer');
const DashPlugin		= require('../react/plugins/dash/renderer');
const DownloadPlugin	= require('../react/plugins/download/renderer');
